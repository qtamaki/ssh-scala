...
import com.qtamaki.concurrent.ErrorDeliveryUtil;
...
import com.qtamaki.sshs.AbstractService;
...
import com.qtamaki.sshs.connection.channel.OpenFailException.Reason;
...
class ConnectionImpl(trans:Transport, keepAlive:KeepAliveProvider)
